...
- KiriKiri/KAG is Experimental (loose .ks + unencrypted XP3 + FE FE 0/1/2; patch.xp3 write; synthetic fixtures + **real extract E2E** Ochiru Hitozuma `patch2.xp3` ~34k strings + **real inject E2E** temp copy: `--direct` → `patch.xp3` 3/3 strings, re-extract finds markers under `patch.xp3/…`; drops pure ellipsis/dot filler lines; no cxdec)
